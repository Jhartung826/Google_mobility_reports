...
for state in states:
    ...
    for c in range(len(data[s]['Counties'])):
        ...
        try:
            print(s)
            data[s]['Counties'][c]['Retail & recreation']
            ...
            if abs(abs(goodplots[p]["e"]) - abs(left_e)) < .0001 and goodplots[p]["f"] in f_top:
                ...
                print(f"its a no go for {data[s]['Counties'][c]['Name']}  at {goodplots[p]['e']}  retail")
                # print(f"retail and rec for {data[s]['Counties'][c]['Name']} is legit with base y of {goodplots[p]['basey']}")
            # else:
            #     if abs(goodplots[p]["e"] - mid_e)>.0001 and (goodplots[p]["f"] > 0 or goodplots[p]["f"]  == -0.17 or goodplots[p]["f"]  == -0.16) and abs(abs(goodplots[p]["e"]) - abs(right_e)) < .0001 and (goodplots[p]["f"] > 0 or goodplots[p]["f"]  == -0.17 or goodplots[p]["f"]  == -0.16)>.0001 and (goodplots[p]["f"] > 0 or goodplots[p]["f"]  == -0.17 or goodplots[p]["f"]  == -0.16):
            #         bad_state_list.append(f'{state} and the {goodplots[p]["e"]} and county {data[s]["Counties"][c]["Name"]} and basex is {goodplots[p]["basex"]}')
            #         e_list.append(goodplots[p]['e'])
            #         a_list.append(goodplots[p]['a'])
            #         b_list.append(goodplots[p]['left_a'])
            #         c_list.append(goodplots[p]['mid_a'])
            #         d_list.append(goodplots[p]['right_a'])
            #         f_list.append(goodplots[p]['f'])
            #         base_x_list.append(goodplots[p]['basex'])
            #         print(f'{state} and the {goodplots[p]["e"]} and county {data[s]["Counties"][c]["Name"]} and {goodplots[p]["basex"]}')
            # ['Nevada', 'Missouri', 'Virginia', 'Maryland'
            # elif state in problem_states:
            #     print(f"{data[s]['Counties'][c]['Name']} state {state} is not good and e is {goodplots[p]['e']} and basex is {goodplots[p]['basex']} retail")
        ...
        try:
            ...
            if abs(abs(goodplots[p]["e"]) - abs(mid_e)) < .0001 and goodplots[p]["f"] in f_top:
                ...
                print(f"its a no go for {data[s]['Counties'][c]['Name']}  at {goodplots[p-1]['f']}  grocery")
            # elif state in problem_states:
        ...
        try:
            ...
            if abs(abs(goodplots[p]["e"]) - abs(right_e)) < .0001 and goodplots[p]["f"] in f_top:
                ...
                print(f"its a no go for {data[s]['Counties'][c]['Name']}  at {goodplots[p-1]['f']}  Parks")
            # elif state in problem_states:
            ...
            #     print(goodplots[p]['data'])
        try:
            data[s]['Counties'][c]['Transit stations']
        ...
        try:
            ...
            if abs(abs(goodplots[p]["e"]) - abs(mid_e)) < .0001 and goodplots[p]["f"] in f_bot:
                ...
                print(f"its a no go for {data[s]['Counties'][c]['Name']}  at {goodplots[p-1]['f']}  workplace")
            # elif state in problem_states:
            #     print(f"{data[s]['Counties'][c]['Name']} state {state} is not good and e is {goodplots[p]['e']} and basex is {goodplots[p]['basex']} work")
            #     print(goodplots[p]['data'])
        except KeyError:
            # print(p)
        ...
        try:
            ...
            if abs(abs(goodplots[p]["e"]) - abs(right_e)) < .0001 and goodplots[p]["f"] in f_bot:
                ...
                print(f"its a no go for {data[s]['Counties'][c]['Name']}  at {goodplots[p-1]['f']}  residential")
            # elif state in problem_states:
